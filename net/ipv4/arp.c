...
const struct neigh_ops arp_broken_ops = {//�ھӳ�ʼ����ʱ�����  �ں���arp_constructor�������
	.family =		AF_INET,
	.solicit =		arp_solicit,
	.error_report =		arp_error_report,
...
//ARP�ھӳ�ʼ��������������ʼ���µ�neibour�ṹʵ�������ھӱ���������neibour_create�б�����  �ú�����arp_tbl�г�ʼ��
// arp构造器
static int arp_constructor(struct neighbour *neigh)
{
...
int arp_bind_neighbour(struct dst_entry *dst)
{
	...
	struct neighbour *n = dst->neighbour;	// 获取设备邻居
...
{
	neigh_table_init(&arp_tbl);	// neighbor表初始化
